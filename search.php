...
if (isset ( $_GET ['q'] )) {
	...
	while ( $row_search = mysql_fetch_assoc ( $search_result ) ) {
		...
		echo "<td><div class=\"work\"><a target=\"_blank\" href=\"http://twitter.com/home/?status=" . $tweet_fix . "\" class=\"icon-button twitter\"><i class=\"icon-twitter\"></i><span></span></a></div></td></tr>";
